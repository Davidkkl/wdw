...
class WdwController extends Controller
{
    ...
    function create_competition(Request $request)
    {
        ...
        if ($fileUrl) {
            ...
            return json_success('报名成功', $data['materials'], 200);
        }
    ...
    function revise_competition(Request $request)
    {
        ...
        if ($fileUrl) {
            ...
            $data['old_competition_name'] = $request['old_competition_name'];
            $student_id = $request['student_id'];
    ...
    function delete_competition(Request $request)
    {
        ...
        $result = competition_stars::deleted($data);

        if ($result === true) {
            return json_success('删除成功', null, 200);
        } elseif ($result === '未找到记录') {
            return json_fail('未找到记录', null, 404);
        } else {
            return json_fail('删除失败', $result, 100);
        }
    }
    ...
    //学生查询科研之星项目信息
    function check_research_project(Request $request)
    {
        $student_id = $request['student_id'];
    ...
    function revise_research_project(Request $request)
    {
        ...
        $data['old_project_name'] = $request['old_project_name'];
        $student_id = $request['student_id'];
    ...
    function delete_research_project(Request $request)
    {
        ...
        $result = research_stars::deleted($data);
    ...
    function revise_research_paper(Request $request)
    {
        ...
        $data['old_journal_name'] = $request['old_journal_name'];
        $student_id = $request['student_id'];
    ...
    function revise_research_software(Request $request)
    {
        ...
        $data['old_software_name'] = $request['old_software_name'];
        $student_id = $request['student_id'];
    ...
    function revise_company(Request $request)
    {
        ...
        $data['old_company_name'] = $request['old_company_name'];
        $student_id = $request['student_id'];
